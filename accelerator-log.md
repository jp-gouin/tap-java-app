...
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┗ ┗ ┗  Info Will replace [<your-selected-appsso-offering>->, <your-workload>->server-side-ui-start...(truncated)]
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┏ engine.transformations[0].validated.delegate.in.transformations[5].delegate.transformations[0].sources[0].validated.delegate.transformations[0].sources[3].delegate.transformations[4] (ReplaceText)
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┏ engine.transformations[0].validated.delegate.in.transformations[5].delegate.transformations[0].sources[0].validated.delegate.transformations[0].sources[4].delegate.transformations[4] (ReplaceText)
